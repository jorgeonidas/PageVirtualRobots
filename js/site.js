...
function replacePpButton(){
   let donateImgEn ="images/English/Donation.png"
    ...
    <div class="paypal" style="background-color: #f3f3f3;">
        <img id="donation-img" src="`+donateImgEn+`" style="width: 100%;height: 75%">
        <form style="padding-top: 0.5rem" action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
